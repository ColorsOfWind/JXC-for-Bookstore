...
CREATE TABLE `user` (
  ...
  `user_P_Qing` varchar(2)   DEFAULT '0',
  `user_P_Ding` varchar(2)   DEFAULT '0',
  `user_P_Yanshou` varchar(2)   DEFAULT '0',
  `user_P_Chuna` varchar(2)   DEFAULT '0',
  `user_P_CheckSale` varchar(2)   DEFAULT '0',
  `user_P_CheckBill` varchar(2)   DEFAULT '0',
