...
class m_suppliers extends CI_Model {
    ...
    */
    ...
    {
        $query = $this->db->query("INSERT INTO supplier_information(sup_Name, sup_Pinyincode,  sup_Tel, sup_Contact, sup_Fax, sup_Postcode, sup_Address, sup_Bank, sup_BankAccount, sup_Email, sup_Internet, sup_Note) VALUES('$supName',  '$supPinyin',  '$supTel', '$supContact', '$supFax', '$supPostcode', '$supAddress', '$supBank', '$supBankAccount', '$supEmail', '$supInternet', '$supNote')");
    ...
    **查询指定供货商，通过ID
    */
    public function checkSuppliersByID($supID)
    {
    ...
    **查询指定供货商，通过名称
    */
    public function checkSuppliersByName($supName)
    {
