...
function verifysame(element1,parent1,element2,parent2) {
...
function verifylength(min,max) {
	if(this.value > min && this.value < max) {
		this.nextSbiling.innerHTML = "请输入正确长度";
